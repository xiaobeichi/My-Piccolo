        ...
        if (action == GLFW_PRESS)
        {
            switch (key)
            {
                ...
                case GLFW_KEY_D:
                    ...
                    break;
                case GLFW_KEY_E:
                    m_game_command |= (unsigned int)GameCommand::addHealth;
                    break;
                case GLFW_KEY_R:
                    m_game_command |= (unsigned int)GameCommand::subHealth;
                    break;
                case GLFW_KEY_SPACE:
        ...
        else if (action == GLFW_RELEASE)
        {
            switch (key)
            {
                ...
                case GLFW_KEY_D:
                    ...
                    break;
                case GLFW_KEY_E:
                    m_game_command &= (k_complement_control_command ^ (unsigned int)GameCommand::addHealth);
                    break;
                case GLFW_KEY_R:
                    m_game_command &= (k_complement_control_command ^ (unsigned int)GameCommand::subHealth);
                    break;
                case GLFW_KEY_LEFT_CONTROL:
